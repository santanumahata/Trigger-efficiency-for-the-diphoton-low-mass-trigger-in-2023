...
# Run2023D-v1 and Run2023D-v2 — NEW HLT filter strings
...
try:
    ...
    options.register('outputFile', 'tnpTree_postBpix_Dv1v2_newString.root',
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(options.inputFiles if options.inputFiles else [
        # Run2023D-v1 test file (EGamma0)
        'root://xrootd-cms.infn.it//store/data/Run2023D/EGamma0/MINIAOD/22Sep2023_v1-v1/40000/0bb00d97-b492-42d5-9d4a-c20d8f52ae1a.root',
    ]),
)
