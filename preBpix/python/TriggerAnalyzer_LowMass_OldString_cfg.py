...
# Run2023C-v1 and Run2023C-v2 — OLD HLT filter strings (same as 2022)
...
try:
    ...
    options.register('outputFile', 'tnpTree_preBpix_Cv1v2_oldString.root',
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(options.inputFiles if options.inputFiles else [
        # Run2023C-v2 test files (EGamma0)
        'root://xrootd-cms.infn.it//store/data/Run2023C/EGamma0/MINIAOD/22Sep2023_v2-v1/40000/b6b896c4-5d8b-43cf-84f7-c8e7ded6abdc.root',
        'root://xrootd-cms.infn.it//store/data/Run2023C/EGamma0/MINIAOD/22Sep2023_v2-v1/40000/cc3e1ac9-324c-415d-a2fd-21ec1a06dc07.root',
    ]),
)
...
SEEDED_FILTER   = "hltEG30Iso60CaloId15b35eR9Id50b90eHE12b10eR9Id50b80eEcalIsoFilter"
UNSEEDED_FILTER = "hltEG18TrackIso60Iso60CaloId15b35eR9Id50b90eHE12b10eR9Id50b80eTrackIsoUnseededFilter"

process.diphotonTnP = cms.EDAnalyzer("DiphotonTnPAnalyzer_OldString",
