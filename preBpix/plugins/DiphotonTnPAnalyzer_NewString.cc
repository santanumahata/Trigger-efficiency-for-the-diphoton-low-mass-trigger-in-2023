// =============================================================================
//  DiphotonTnPAnalyzer_NewString.cc
//
//  For: Run2023C-v3, Run2023C-v4, Run2023D-v1, Run2023D-v2
//  HLT filter bits changed from Run2023C-v3 ("new strings")
//
...
// =============================================================================
class DiphotonTnPAnalyzer_NewString
    : public edm::one::EDAnalyzer<edm::one::SharedResources> {

public:
    explicit DiphotonTnPAnalyzer_NewString(const edm::ParameterSet&);
    ~DiphotonTnPAnalyzer_NewString() override = default;
...
//  Constructor
// =============================================================================
DiphotonTnPAnalyzer_NewString::DiphotonTnPAnalyzer_NewString(const edm::ParameterSet& iConfig)
...
// =============================================================================
void DiphotonTnPAnalyzer_NewString::beginJob()
{
...
//  analyze
// =============================================================================
void DiphotonTnPAnalyzer_NewString::analyze(const edm::Event&      iEvent,
...
// =============================================================================
bool DiphotonTnPAnalyzer_NewString::passesProbePreselection(const pat::Photon& pho) const
{
...
//  passesTagSelection
// =============================================================================
bool DiphotonTnPAnalyzer_NewString::passesTagSelection(
...
//  getClosestObject
// =============================================================================
DiphotonTnPAnalyzer_NewString::MatchResult
DiphotonTnPAnalyzer_NewString::getClosestObject(
    const reco::Candidate::LorentzVector&            p4,
    const std::vector<pat::TriggerObjectStandAlone>& objs,
    const std::string&                               filterLabel) const
{
...
//  pathFired
// =============================================================================
bool DiphotonTnPAnalyzer_NewString::pathFired(const edm::TriggerResults& trigResults,
                                               const edm::TriggerNames&   trigNames,
                                               const std::string&         partialName) const
{
...
//  clearBranches
// =============================================================================
void DiphotonTnPAnalyzer_NewString::clearBranches()
{
...
//  fillDescriptions
// =============================================================================
void DiphotonTnPAnalyzer_NewString::fillDescriptions(
    edm::ConfigurationDescriptions& descriptions)
{
    ...
    // NEW filter strings — valid for Run2023C-v3, v4 and Run2023D
    desc.add<std::string>("seededFilter",
        "hltEG30Iso60b40eCaloId11b32eHE10b9eR9Id50b90eEcalIsoFilter");
...
// =============================================================================
DEFINE_FWK_MODULE(DiphotonTnPAnalyzer_NewString);
